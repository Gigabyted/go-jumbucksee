...
import (
	...
	"github.com/jumbucks/go-jumbucksee/internal/jsre"
	"github.com/jumbucks/go-jumbucksee/internal/web3ext"
...
// Welcome show summary of current Gjbsee instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gjbsee metadata
	fmt.Fprintf(c.printer, "Welcome to the Gjbsee JavaScript console!\n\n")
	c.jsre.Run(`
