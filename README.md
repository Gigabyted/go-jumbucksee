 ...
 * Start up Geth's built-in interactive [JavaScript console](https://github.com/jumbucks/go-jumbucksee/wiki/JavaScript-Console),
   (via the trailing `console` subcommand) through which you can invoke all official [`web3` methods](https://github.com/ethereum/wiki/wiki/JavaScript-API)
   as well as Geth's own [management APIs](https://github.com/jumbucks/go-jumbucksee/wiki/Management-APIs).
...
[Geth specific APIs](https://github.com/jumbucks/go-jumbucksee/wiki/Management-APIs)). These can be
