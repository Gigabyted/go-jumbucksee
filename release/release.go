...
import (
	...
	"github.com/jumbucks/go-jumbucksee/accounts/abi/bind"
	...
	for {
		...
		case <-timer.C:
			...
			if version.Major > r.config.Major ||
				...
				howtofix := fmt.Sprintf("Please check https://github.com/jumbucks/go-jumbucksee/releases for new releases")
