...
var (
	...
	authorsFileHeader = "# This is the official list of go-jumbucksee authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-jumbucksee Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-jumbucksee"
	}
	if startOfSentence {
		return "The go-jumbucksee library"
	}
	return "the go-jumbucksee library"
}
